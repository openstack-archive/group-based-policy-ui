...
urlpatterns = patterns( '',
    ...
    url(r'^sc_node/(?P<scnode_id>[^/]+)/$', views.ServiceChainNodeDetailsView.as_view(), name='sc_node_details'),
    ...
    url(r'^sc_spec/(?P<scspec_id>[^/]+)/$', views.ServiceChainSpecDetailsView.as_view(), name='sc_spec_details'),
    ...
    url(r'^sc_instance/(?P<scinstance_id>[^/]+)/$', views.ServiceChainInstanceDetailsView.as_view(), name='sc_instance_details'),
)
