...
class UpdatePolicyTargetForm(forms.SelfHandlingForm):
    ...
    provided_policy_rule_sets = forms.MultipleChoiceField(label=_("Provided Policy Rule Set"),required=False)
    consumed_policy_rule_sets = forms.MultipleChoiceField(label=_("Consumed Policy Rule Set"),required=False)
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        try:
            ...
            provided = [client.policy_rule_set_get(request,item) for item in policy_target.provided_policy_rule_sets]
            consumed = [client.policy_rule_set_get(request,item) for item in policy_target.consumed_policy_rule_sets]
            self.fields['provided_policy_rule_sets'].initial = provided
            self.fields['consumed_policy_rule_sets'].initial = consumed
            tenant_id = self.request.user.tenant_id
            policy_rule_sets = client.policy_rule_set_list(request, tenant_id=tenant_id)
            ...
            self.fields['provided_policy_rule_sets'].choices = policy_rule_set_list
            self.fields['consumed_policy_rule_sets'].choices = policy_rule_set_list
        except Exception as e:
            exceptions.handle(request, _('Unable to retrieve policy_rule_set details.'))
            pass
    ...
    def handle(self, request, context):
        ...
        try:
            context['provided_policy_rule_sets'] = dict([(i,'string') for i in context['provided_policy_rule_sets']])
            context['consumed_policy_rule_sets'] = dict([(i,'string') for i in context['consumed_policy_rule_sets']])
            policy_target = client.policy_target_update(request, policy_target_id, **context)
...
class CreateContractForm(forms.SelfHandlingForm):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        try:
            ...
            policy_target = client.policy_target_get(request, policy_target_id)
            providedpolicy_rule_sets = policy_target.get("provided_policy_rule_sets") 
            items = client.policy_rule_set_list(request, tenant_id=tenant_id)
            policy_rule_sets = [(p.id,p.name) for p in items if p.id not in providedpolicy_rule_sets]
        except Exception as e:
            pass
    ...
    def handle(self,request,context):
        policy_target_id = self.initial['policy_target_id']
        policy_target = client.policy_target_get(request, policy_target_id)
        url = reverse("horizon:project:policytargets:policy_targetdetails", kwargs={'policy_target_id': policy_target_id})
        try:
            for policy_rule_set in policy_target.get("provided_policy_rule_sets"):
                context['policy_rule_set'].append(policy_rule_set)
            policy_rule_sets = dict([(item,'string') for item in context['policy_rule_set']])
            client.policy_target_update(request,policy_target_id,provided_policy_rule_sets=policy_rule_sets)
...
class RemoveContractForm(forms.SelfHandlingForm):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        try:
            ...
            providedpolicy_rule_sets = policy_target.get("provided_policy_rule_sets") 
            items = client.policy_rule_set_list(request, tenant_id=tenant_id)
            policy_rule_sets = [(p.id,p.name) for p in items if p.id in providedpolicy_rule_sets] 
        except Exception as e:
            pass
        self.fields['policy_rule_set'].choices = policy_rule_sets
    ...
    def handle(self,request,context):
        ...
        try:
            policy_target = client.policy_target_get(request, policy_target_id)
            old_policy_rule_sets = policy_target.get("provided_policy_rule_sets")
            for policy_rule_set in context['policy_rule_set']:
                old_policy_rule_sets.remove(policy_rule_set)
            policy_rule_sets = dict([(item,'string') for item in old_policy_rule_sets])
            client.policy_target_update(request,policy_target_id,provided_policy_rule_sets=policy_rule_sets)
...
class AddConsumedForm(forms.SelfHandlingForm):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        try:
            ...
            policy_target_id = kwargs['initial']['policy_target_id']
            policy_target = client.policy_target_get(request, policy_target_id)
            consumedpolicy_rule_sets = policy_target.get("consumed_policy_rule_sets")             
            items = client.policy_rule_set_list(request, tenant_id=tenant_id)
            policy_rule_sets = [(p.id,p.name) for p in items if p.id not in consumedpolicy_rule_sets]
        except Exception as e:
            pass
        self.fields['policy_rule_set'].choices = policy_rule_sets
    ...
    def handle(self,request,context):
        ...
        try:
            policy_target = client.policy_target_get(request, policy_target_id)
            for policy_rule_set in policy_target.get("consumed_policy_rule_sets"):
                context['policy_rule_set'].append(policy_rule_set)
            consumed = dict([(item,'string') for item in context['policy_rule_set']])
            client.policy_target_update(request,policy_target_id,consumed_policy_rule_sets=consumed)
            msg = _('Contract Added successfully!')
            messages.success(request, msg)
            LOG.debug(msg)
            return http.HttpResponseRedirect(url)
...
class RemoveConsumedForm(forms.SelfHandlingForm):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        try:
            ...
            consumedpolicy_rule_sets = policy_target.get("consumed_policy_rule_sets") 
            items = client.policy_rule_set_list(request, tenant_id=tenant_id)
            policy_rule_sets = [(p.id,p.name) for p in items if p.id in consumedpolicy_rule_sets]
        except Exception as e:
            pass
        self.fields['policy_rule_set'].choices = policy_rule_sets
    ...
    def handle(self,request,context):
        ...
        try:
            policy_target = client.policy_target_get(request, policy_target_id)
            old_policy_rule_sets = policy_target.get("consumed_policy_rule_sets")
            for policy_rule_set in context['policy_rule_set']:
                old_policy_rule_sets.remove(policy_rule_set)
            consumed = dict([(item,'string') for item in old_policy_rule_sets])
            client.policy_target_update(request,policy_target_id,consumed_policy_rule_sets=consumed)
            msg = _('Contract removed successfully!')
            messages.success(request, msg)
            LOG.debug(msg)
